                ...
                >
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            whileHover={{ y: -5, boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }}
                        >
                            <motion.h3 className="text-lg font-bold text-[#1a2f4a]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
                                Welcome, {user.name || 'User'}! 👋
                            </motion.h3>
                            <motion.p className="text-gray-500 mt-3 text-sm md:text-base" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                                You are logged in as <strong>{user.role || 'User'}</strong>.
                            </motion.p>
                            <motion.div className="mt-4 p-3 bg-gray-100 rounded-lg" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
